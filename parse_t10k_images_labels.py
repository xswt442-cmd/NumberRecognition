...
data_file = r'.\MNIST_data\t10k-images-idx3-ubyte\t10k-images.idx3-ubyte'
# 文件大小是7840016B,但实际数据是7840000B(需要减去16字节的文件头)
...
label_file = r'.\MNIST_data\t10k-labels-idx1-ubyte\t10k-labels.idx1-ubyte'
# 文件大小是10008B,但实际数据是10000B(需要减去8字节的文件头)
